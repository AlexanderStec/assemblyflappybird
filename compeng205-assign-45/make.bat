...
ml /I%MASMINCPATH% /c  /coff  /Cp pipe.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp ground.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp back.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp bird.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp birddown.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp birdup.asm

if %errorlevel% neq 0 goto :error

link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj pipe.obj ground.obj back.obj bird.obj birddown.obj birdup.obj libgame.obj
